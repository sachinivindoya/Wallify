...
class ExploreTab extends Component {
    ...
    loadData = async (page) => {
        ...
        const response = await fetch(`https://api.unsplash.com/search/photos?client_id=${XY1RG01nyvl_cf1VpxD3aTShYUNMqP9KnEqQT1B5Okg}&page=${page}&query=${query ? query : 'wallpaper'}`);
